...
#define D_PPP_my_PL_parser_var(var) ((PL_parser ? PL_parser : (croak("panic: PL_parser == NULL in %s:%d", __FILE__, __LINE__), (yy_parser *)NULL))->var)
#else
...
#endif
#ifndef CopSTASH_eq
#define CopSTASH_eq(c, hv) ((hv) && (CopSTASHPV(c) == HvNAME(hv) || (CopSTASHPV(c) && HvNAME(hv) && strEQ(CopSTASHPV(c), HvNAME(hv)))))
#endif
#else
#ifndef CopFILEGV
